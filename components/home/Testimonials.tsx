const TESTIMONIALS = [
  {
    name: 'Sarah T.',
    quote: 'Transparent pricing and friendly staff. The car was spotless and ready to go.',
  },
  {
    name: 'Mark L.',
  ...
  {
    name: 'Priya D.',
    quote: 'Fast trade-in valuation and excellent communication from start to finish.',
  },
];
